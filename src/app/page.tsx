...
export default function Home() {
  ...
  return (
    <div className="min-h-screen relative bg-neutral-100 dark:bg-black p-4 md:p-8 md:px-24 lg:p-16 flex flex-col lg:flex-row lg:items-start gap-14 xl:px-26 transition-colors duration-300">
      <SideCard />
      <div
        className="relative p-4 pb-24 md:p-8 bg-white dark:bg-neutral-900 rounded-3xl border border-neutral-200 dark:border-neutral-700 gap-4 w-full mb-20 lg:mb-0 transition-all duration-500 ease-in-out shadow-md"
      >
      ...
      <div className="fixed flex md:hidden bottom-3 left-3 right-3 h-14 z-30 items-center bg-white/90 dark:bg-neutral-800/90 rounded-2xl backdrop-blur-xl border border-neutral-200 dark:border-neutral-700 shadow-lg px-2 gap-2" >
